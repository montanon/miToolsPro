...
from mitoolspro.utils.context_vars import Context, ContextVar
...
class TestContextVars(TestCase):
    ...
    def test_value_accross_modules(self):
        ...
        exec(
            'from mitoolspro.utils.context_vars import ContextVar;C = ContextVar("C", 13)',
            {},
    ...
    def test_assignment_across_modules(self):
        ...
        exec(
            'from mitoolspro.utils.context_vars import ContextVar;B = ContextVar("B", 0);B.value = 3;',
            {},
        )  # pylint:disable=exec-used
