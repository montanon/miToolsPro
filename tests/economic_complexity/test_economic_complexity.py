...
class TestCalculateProximityMatrix(TestCase):
    ...
    def test_empty_dataframe(self):
        empty_df = DataFrame()
        self.assertRaises(ArgumentValueError, calculate_proximity_matrix, empty_df)
...
class TestCalculateRelatednessMatrix(TestCase):
    ...
    def test_empty_matrices(self):
        ...
        empty_rca = DataFrame()
        self.assertRaises(
            ArgumentValueError, calculate_relatedness_matrix, empty_proximity, empty_rca
        )
...
class TestCalculateEconomicComplexity(TestCase):
    ...
    def test_fast_option(self):
        ...
        self.assertLess(
            fast_time,
            standard_time / 2 if False else fast_time + 0.1,
        ...
        assert_frame_equal(eci_fast, eci_standard, check_dtype=False)
        assert_frame_equal(pci_fast, pci_standard, check_dtype=False)
